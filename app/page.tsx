...
export default function HomePage({
  ...
  const t = isFR
    ...
    : {
        ...
        servicesTitle: "Services",
        servicesSubtitle: "Compatible key fob duplication and garage remote programming.",
        book: "Book Now",
      ...
      <section className="py-16 bg-gray-50 border-b">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-3">{t.howTitle}</h2>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {services.map((service) => {
              const content = isFR ? service.fr : service.en;
              return (
                <div
                  key={service.id}
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 text-lg">{content.name}</h3>
                      <p className="text-2xl font-bold text-blue-600">${service.price}.00</p>
                    </div>
                  </div>
                  <p className="text-gray-600 mb-6 flex-1">{content.desc}</p>
                  <Link
