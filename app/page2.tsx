...
export default function HomePage({
  ...
  const t = isFR
    ? {
        heroTitle1: "Cópia de porte-clés (Fob) em Toronto",
        heroTitle2: "Rápido e Profissional",
        heroSubtitle:
          "Encomende online em minutos. Carregue fotos, confirme os detalhes e escolha levantamento ou entrega.",
        ctaStart: "Começar Encomenda",
        ctaCompat: "Verificar Compatibilidade",
        disclaimer: "Apenas para utilizadores autorizados. Sujeito a compatibilidade técnica.",
        trust1: "Serviço Rápido",
        trust1d: "Conforme disponibilidade",
        trust2: "Compatibilidade",
        trust2d: "Sistemas suportados",
        trust3: "Toronto & GTA",
        trust3d: "Zona de serviço",
        howTitle: "Como funciona",
        step1: "Encomenda",
        step1d: "Escolha o serviço e detalhes.",
        step2: "Fotos",
        step2d: "Frente e verso nítidas.",
        step3: "Verificação",
        step3d: "Confirmamos antes de prosseguir.",
        step4: "Entrega",
        step4d: "Levantamento ou envio.",
        pickup: "Levantamento",
        pickupd: "Pontos de recolha convenientes.",
        delivery: "Entrega",
        deliveryd: "Disponível em toda a GTA.",
        faqTitle: "Perguntas Frequentes",
        q1: "Copia qualquer comando?",
        a1: "Duplicamos fobs compatíveis. Deve ser um utilizador autorizado.",
        q2: "Têm acesso ao sistema do prédio?",
        a2: "Não. Apenas duplicamos a credencial física apresentada.",
        q3: "A cópia é garantida?",
        a3: "Não. Alguns sistemas são encriptados e não podem ser copiados.",
        q4: "Efetuam reembolsos?",
        a4: "Não há reembolso após tentativa de duplicação. Consulte os Termos.",
        ctaBottomTitle: "Pronto para começar?",
        ctaBottomText: "Carregue as suas fotos para validação imediata.",
        getStarted: "Começar Agora",
        jumpServices: "Serviços",
        jumpPickup: "Recolha",
        jumpFaq: "FAQ",
      }
    : {
        ...
        disclaimer: "Authorized users only. Duplication subject to technical compatibility.",
        trust1: "Fast Service",
        ...
        step1: "Place Order",
        step1d: "Choose service and details.",
        step2: "Upload Photos",
        step2d: "Clear front/back photos.",
        step3: "Verification",
        step3d: "We confirm before proceeding.",
        step4: "Get Your Fob",
        step4d: "Pickup or GTA delivery.",
        pickup: "Pickup",
        pickupd: "Convenient pickup options.",
        delivery: "Delivery",
        deliveryd: "Available across Toronto & GTA.",
        faqTitle: "Frequently Asked Questions",
        q1: "Do you copy fobs for any building?",
        a1: "We duplicate compatible key fobs. Client must be an authorized user.",
        q2: "Do you need system access?",
        a2: "No. We only duplicate the physical credential presented.",
        q3: "Is duplication guaranteed?",
        a3: "No. Some fobs are encrypted or restricted and cannot be copied.",
        q4: "Do you offer refunds?",
        a4: "No refunds after a duplication attempt is made. See Terms.",
        ctaBottomTitle: "Ready to start?",
        ctaBottomText: "Upload your photos so we can verify compatibility instantly.",
      ...
      <section className="py-24 bg-slate-50/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-extrabold tracking-tighter uppercase mb-4">
              {t.howTitle}
            </h2>
      ...
      <section id="pickup" className="py-24 bg-white scroll-mt-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="group relative bg-slate-900 text-white rounded-[3rem] p-10 md:p-16 overflow-hidden">
              <div className="relative z-10">
                <div className="inline-flex p-4 rounded-2xl bg-blue-600 mb-8">
                  <Store size={32} />
                </div>
                <h3 className="text-3xl md:text-4xl font-extrabold uppercase mb-6 tracking-tighter">
                  {t.pickup}
                </h3>
                ...
                <div className="flex items-center gap-2 text-blue-400 font-bold uppercase tracking-widest text-xs">
                  <MapPin size={16} /> Toronto, ON
                </div>
              </div>
              <Store className="absolute -right-12 -bottom-12 w-64 h-64 text-white/5 group-hover:scale-110 transition-transform duration-500" />
            </div>

            <div className="group relative bg-blue-600 text-white rounded-[3rem] p-10 md:p-16 overflow-hidden shadow-[0_30px_60px_-15px_rgba(37,99,235,0.4)]">
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-2 text-white/80 font-bold uppercase tracking-widest text-xs">
                  <Clock size={16} /> Same-day options
                </div>
              </div>
              <Truck className="absolute -right-12 -bottom-12 w-64 h-64 text-black/5 group-hover:scale-110 transition-transform duration-500" />
            </div>
          </div>
        </div>
      </section>

      {/* FAQ - Refined Minimalist */}
      <section id="faq" className="py-24 bg-slate-50 scroll-mt-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold uppercase tracking-tighter mb-4">
              {t.faqTitle}
            </h2>
          </div>
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="bg-white rounded-3xl border border-slate-200 p-8 hover:border-blue-400 transition-colors"
              >
                <h3 className="text-lg font-extrabold uppercase mb-3 text-blue-600 tracking-tight">
                  {item.q}
                </h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative bg-slate-950 rounded-[4rem] p-12 md:p-24 text-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-extrabold text-white uppercase tracking-tighter mb-8">
                {t.ctaBottomTitle}
              </h2>
              ...
              <Link
                href={withLang("/book")}
                className="inline-flex items-center gap-4 bg-white text-slate-950 hover:bg-blue-500 hover:text-white px-12 py-6 rounded-2xl font-extrabold text-xl transition-all shadow-2xl hover:scale-105 uppercase tracking-tight"
              >
